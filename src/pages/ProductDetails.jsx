          ...
          {language === "anglais" ? (
            <div className="alert">
              {toggleSingleProductData ? (
                ...
                `1M=1,000,000 Kamas. Attention: ibytrade will never ask you to
                ...
                kamas or items to someone who claims to be ibytrade.`
              )}
            </div>
          ) : language === "espagnol" ? (
            <div className="alert">
              ...
              <div className="dofus-productdetails">
                ...
                <div className="productdetails-choose">
                  ...
                  <div className="productdetails-choose-qtyselect">
                    ...
                    <span className="productdetails-choose-qtyselect-absolute">
                      KAMAS
                    </span>
                  </div>
