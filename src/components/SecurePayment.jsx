  ...
  return language === "anglais" ? (
    <div className="secure-payment">
      ...
      <p className="secure-payment-intro">
        ...
        made on ibytrade is 100% secured. These trusted partners, whose
      ...
      <div className="methode-of-payment">
        ...
        <p>
          ...
          shops, including including ibytrade of course! As the name suggests,
    ...
    <div className="secure-payment">
      ...
      <p className="secure-payment-intro">
        ...
        asegurarse de que cualquier pago hecho en ibytrade es 100% seguro.
        Estos socios de confianza, cuyos reputación es insuperable, se enumeran
        a continuación:
      </p>
      <div className="methode-of-payment">
      ...
      <div className="methode-of-payment">
        ...
        <p>
          ...
          información proporcionada como el RIB, el nombre es estrictamente
          confidencial.
        </p>
      </div>
      <div className="methode-of-payment">
        ...
        <p>
          ...
          miles de online tiendas, incluyendo ibytrade por supuesto! Como el
    ...
    <div className="secure-payment">
      ...
      <p className="secure-payment-intro">
        ...
        pour nous assurer que tout paiement effectué sur ibytrade est 100%
      ...
      <div className="methode-of-payment">
        ...
        <img src={card} alt="card" />
        <p>
          Le paiement par virement bancaire est entièrement sécurisé. Les
      ...
      <div className="methode-of-payment">
        ...
        <p>
          ...
          compris ibytrade bien sûr! Comme son nom l’indique, Paysafecard est
