      ...
      <details className="alert">
        ...
        {language === "anglais" && (
          <p>
            ...
            kind of reason are scammers. An ibytrade agent will never make this
        ...
        {language === "espagnol" && (
          <p>
            ...
            ibytrade nunca hará esto tipo de solicitud, ya que toda la
        ...
        {language === "francais" && (
          <p>
            ...
            ibytrade ne fera jamais ce type de demande, car toute communication
