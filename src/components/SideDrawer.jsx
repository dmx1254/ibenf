  ...
  return (
    <div className={sideDrawerClass.join(" ")}>
      ...
      <div className="sidedrawer-third">
        {language === "anglais" && (
          <p>
            <span className="sidedrawer-third-go">ibytrade</span>,sells kamas
        ...
        {language === "francais" && (
          <p>
            <span className="sidedrawer-third-go">ibytrade</span> vend des kamas
            pour les jeux Dofus, Dofus Retro et Dofus Touch à des prix défiant
            toute concurrence. Notre objectif principal est une livraison rapide
            et à moindre coût. Nous vous garantissons un service d'excellence
            24h/24, 7j/7.
        ...
        {language === "espagnol" && (
          <p>
            <span className="sidedrawer-third-go">ibytrade</span> vende Kamas
