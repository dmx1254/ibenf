    ...
    <div className="checkoutSuccess">
      {language === "anglais" && (
        <div className="checkoutSuccess-container">
          ...
          <p className="checkout-desc">
            Thank you for placing your order on ibytrade 🎉
          </p>
      ...
      {language === "espagnol" && (
        <div className="checkoutSuccess-container">
          ...
          <p className="checkout-desc">
            Gracias por hacer tu pedido en ibytrade 🎉
          </p>
          <div className="checkoutSuccess-container-btn">
            {/* <button>No</button> */}
            <button>
      ...
      {language === "francais" && (
        <div className="checkoutSuccess-container">
          ...
          <p className="checkout-desc">
            Merci d'avoir passé votre commande sur ibytrade 🎉
          </p>
          <Link to="/">
            <div className="checkoutSuccess-container-btn">
              {/* <button>No</button> */}
      ...
      {/* {language === "anglais" && (
        <h2>Thank you for placing your order on ibytrade 🎉 </h2>
      )} */}
      {/* {language === "francais" &&
        swal({
          title: "Paiement réussi!",
          text: "Merci d'avoir passé votre commande sur ibytrade ! 🎉",
          icon: "success",
          buttons: "OK",
        })} */}
      {/* {language === "francais" && (
        <h2>Merci d'avoir passé votre commande sur ibytrade ! 🎉</h2>
      )}
      {language === "espagnol" && (
        <h2>Gracias por hacer tu pedido en ibytrade ! 🎉 </h2>
      )} */}
      <ToastContainer
        position="top-center"
        autoClose={5000}
