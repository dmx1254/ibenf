  ...
  return language === "anglais" ? (
    <div className="productdescription">
      <p className="productdescription-desc">
        <div>
          <p>
            Why buy Kamas <strong>{serverDesc}</strong> on ibytrade?{" "}
          </p>
          <br></br>
          <span>
            <strong>Speed ✨</strong>
          ...
          <br></br>
          <p>
            Since the creation of the ibytrade site, speed delivery has been
          ...
          <br></br>
          <p>
            On ibytrade, you can buy Kamas <strong>{serverDesc}</strong> at low
            ...
            safe. Save time and fully enjoy your game with ibytrade. Best price
    ...
    <div className="productdescription">
      <p className="productdescription-desc">
        <div>
          <p>
            Por qué comprar Kamas <strong>{serverDesc}</strong> en ibytrade?{" "}
          </p>
          <br></br>
          <span>
          ...
          <br></br>
          <p>
            Desde la creación del sitio ibytrade, la entrega rápida ha sido
          ...
          <br></br>
          <p>
            En ibytrade, puede comprar Kamas <strong>{serverDesc}</strong> a
            ...
            y disfrute plenamente de su juego con ibytrade. Mejor precio en el
    ...
    <div className="productdescription">
      <p className="productdescription-desc">
        <div>
          ...
          <br></br>
          <p>
            Depuis la création du site ibytrade , la rapidité de livraison est
          ...
          <br></br>
          <p>
            Chez ibytrade, vous pouvez acheter des Kamas sur{" "}
            ...
            profitez pleinement de votre jeu avec ibytrade.Meilleur prix sur le
